          ...
          <div className="col-lg-5 d-flex align-items-stretch">
            <div className="info">
              <div className="address">
                <i className="icofont-google-map"><img alt="" src="images/Locationicon.png"/></i>
                <h4>Location:</h4>
                <p> Oyo State, Nigeria</p>
              </div>

              <div className="email">
                <i className="icofont-envelope"><img alt="" src="images/Messageicon.png"/></i>
                <h4>Email:</h4>
                <p>akinyemiiyanu45@gmail.com</p>
              </div>

              <div className="phone">
                <i className="icofont-phone"><img alt="" src="images/phoneicon.png"/></i>
                <h4>Call:</h4>
            ...
            <form action="" method="post" role="form" className="php-email-form">
              <div className="form-row">
                ...
                <div className="form-group col-md-6">
                  ...
                  <input type="button" value="https://wa.me/message/2349037298121" className="form-control" name="email" id="email" data-rule="email" data-msg="Please enter a valid email" />
                  </a>
                  <div className="validate"></div>
                </div>
              </div>
